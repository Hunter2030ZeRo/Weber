...
[validation record](weber/packaging/results/ae00460.json), [window-state scope](weber/electron-runtime/WINDOW_STATE.md)
and [menu-bar scope](weber/electron-runtime/MENUBAR.md).
