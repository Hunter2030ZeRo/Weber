...
a query, not offscreen rendering. See the [validation record](weber/packaging/results/3e1fb44.json).
...
Six diagnostic tests pass. The [preceding run](weber/packaging/results/bd112a9.json) established
