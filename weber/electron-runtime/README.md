...
[validation record](../packaging/results/f3c16b8.json) and [HTTP protocol scope](HTTP_PROTOCOL.md).
...
original Request/Response adapter. [HTTP protocol forwarding](HTTP_PROTOCOL.md) supports bounded upstream responses
with session policy and cancellation. Persistent cookies/storage, native response
streaming, service workers and CSP bypass remain unsupported.
