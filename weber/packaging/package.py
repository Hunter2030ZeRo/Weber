...
RUNTIME_HELPERS = (
    ...
    "host-client.cjs", "ipc-reply-queue.cjs", "menu-binding.cjs", "protocol-binding.cjs", "protocol-http.cjs", "clipboard-binding.cjs", "display-binding.cjs", "notification-binding.cjs", "message-port-binding.cjs", "global-shortcut-binding.cjs", "platform-app.cjs",
    "power-binding.cjs", "power-save-binding.cjs", "titlebar-options.cjs",
    "desktop-capturer-binding.cjs",
    "net-binding.cjs", "net-url-loader.cjs", "utility-api.cjs",
